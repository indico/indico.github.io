...
It's with great pleasure that we announce the deployment of **Indico 3.0** at CERN and thus a major step towards a public releaase. It is a very important milestone in the history of the Project. Two groundbreaking developments happened during these last months, one of them very visible, while the other one not directly noticeable but nonetheless of vital importance.
But lets get to it!
