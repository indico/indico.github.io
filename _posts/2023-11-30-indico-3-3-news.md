...
<!-- Read our full in-depth blog post about the new Check-in app [here](https://indico.io/blog/future-link-to-a-post-about-the-check-in-app/). -->
...
- Links can now be added automatically, based on patterns in notes/minutes (e.g. issue trackers, GitHub repos etc.) <!-- wonder if this one isn't big enough to deserve its own section/screenshots? --> <!-- I agree -->
